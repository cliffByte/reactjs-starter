...
import { verifyOtpSchema } from "../../../config/schema/authSchema";
              ...
              <Form onSubmit={(e) => handleSubmit(e)}>
                <div className="input_group mb-4">
                  <CustomInput
                    ...
                    placeholder="Enter your otp sent to your email"
                    error={errors.otp === undefined ? false : true}
                    onChange={handleChange}
                    name="otp"
                    value={values.otp}
                  />
                  <small className="input_suggestion_error">{errors.otp}</small>
                </div>
